/*
 * $Id: Host.java,v 1.2 2002/11/08 11:14:31 dreami Exp $
 *
...
/**
 * Represent a nick!ident@host combination, or simply a 'hostmask'.<P>
 *
...
public class Host
{
    ...
    public Host(String hostString) {
      if ( hostString == null ) {
	Log.error(this, "constructor: hostString == null!");
	throw new IllegalArgumentException("hostString argument null!");
      }
      ...
      if( atIndex == -1 ) {
	Log.debug(this, "Host(): bad host string (" + hostString + ")");
      } else {
