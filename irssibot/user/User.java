/*
 * $Id: User.java,v 1.2 2002/11/08 11:14:31 dreami Exp $
 *
...
public class User
{
     ...
     * the hosts into another Vector as Host objects.<P>
     * 
    ...
    /**
     * Checks if user has a matching host.<P>
     *
	...
	while( en.hasMoreElements() ) {
	    UserChannelInfo chanInfo = (UserChannelInfo)en.nextElement();
	...
	if( globalFlags != null ) {
	    ...
	    Log.debug(this, "processGlobalFlagsString(): null globalFlags");
	}
    }
}
