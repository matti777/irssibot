/*
 * $Id: StringUtil.java,v 1.2 2002/11/08 11:14:31 dreami Exp $
 *
...
/**
 * Includes a collection of handy tools for parsing and editing strings.<P>
 *
...
public final class StringUtil {
  /**
   * Replaces strings of characters in a String with anothers.<P>
   *
   * @param s string whose substrings to replace
   * @param sub substring to be replaced
   * @param replacement new substring to replace
   * @return new string with given substrings replaced
   */
  public static String replace(String s, String sub, String replacement) {
    String str = "";
    int index = 0;
    ...
    while ( index != -1 ) {
      index = s.indexOf(sub);
      if ( index != -1 ) {
	str += s.substring(0, index) + replacement;
     ...
     * <ul>
     *   <li>trimming
     *   <li>removal of leading/trailing occurrences of the separator characters
     *   <li>checking for emptiness
     * </ul>
     *
     * @param input input string
    ...
    /**
     * Do wildcard matching for two strings. Comparison is not case sensitive.<P>
     *
